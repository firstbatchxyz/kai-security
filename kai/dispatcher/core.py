...
class Dispatcher:
    ...
    async def boot(
        ...
        try:
            ...
            # Save invariants (state manager stores ID mappings internally)
            await self._persist(
            ...
            # Persist campaigns (uses internal invariant mappings, stores campaign mappings)
            await self._persist(
            ...
            # Persist missions (uses internal campaign and invariant mappings)
            await self._persist(
